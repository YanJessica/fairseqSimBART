...
import sys
sys.path.append('/home/ubuntu/project/semsim/fairseq-semsim/fairseq/new_criterions/newLoss/Siamese_LSTM_python3')
...
@register_criterion('semantic_similarity_loss_new_rewarder')
class SemanticSimilarityCriterion(FairseqCriterion):
    ...
    def __init__(self, args, task):
        ...
        self.loss_weight = -15#args.loss_weight
